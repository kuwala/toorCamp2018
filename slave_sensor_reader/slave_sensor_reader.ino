...
int delayBetweenSends = 3000;  //delay 3 seconds between sends for troubleshooting
...
int numberOfSensors = 21;
byte analogPins[] = {A0,A1,A2,A3,A4,A5,A6,A7,A8,A9,A12,A13,A14,A15,A16,A17,A18,A19,A20,A21,A22};

int sensorValue[21];
int sensorThreshold[21] = {100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100};
